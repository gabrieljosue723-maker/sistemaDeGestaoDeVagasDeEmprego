...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-neutral-800 text-sm font-medium leading-5 text-neutral-900 focus:outline-none focus:border-neutral-900 transition duration-150 ease-in-out'
